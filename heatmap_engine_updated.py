...
# NSE burst tracking list.
# Index burst was stopped because index names were not present in this active list.
# Added BANKNIFTY, NIFTY, MIDCPNIFTY back at the top.
...
# MCX burst alerts are temporarily held/disabled until further instruction.
# To start MCX again later, restore: ["CRUDEOIL", "CRUDEOILM"]
